...
import { FriendshipResult } from "../astro/friendship";
...
export default function FriendshipExportReport({
      ...
      <div className="export-shell" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="chart-report match-report">
          <header className="report-head">
            <h1>☸ Aistrology — Friendship Compatibility Report</h1>
          ...
          <section>
            <h2>
              {VERDICT_EMOJI[result.verdict]} Friendship Score: {result.totalScore} / {result.maxScore} — {result.verdict}
            </h2>
          ...
          <footer className="report-foot">
            Generated by Aistrology · Friendship Compatibility Analysis · for learning
