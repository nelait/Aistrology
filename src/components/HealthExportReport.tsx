      ...
      <div className="export-shell" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="chart-report match-report">
          <header className="report-head">
            <h1>☸ Shastri — Health Analysis Report</h1>
          ...
          <footer className="report-foot">
            Generated by Shastri · Health Analysis · for learning and reflection only. <strong>This is not medical advice.</strong> Always consult qualified healthcare professionals.
          </footer>
        </div>
      </div>
    </div>
