...
/** Right-edge "Lessons" handle + slide-in drawer: chapter list by track,
 * a chapter reader with prev/next, progress ticks, and deep links into the app. */
          ...
          >
            <header className="lessons-head">
              <div className="lessons-head-top">
                ...
                <button className="chat-icon" onClick={() => setOpen(false)} aria-label="Close lessons">✕</button>
              </div>
              {!reading && (
                <>
            ...
            {reading ? (
              <ChapterReader
                ...
                onSeeIn={(tab) => { setOpen(false); onGoToTab(tab); }}
