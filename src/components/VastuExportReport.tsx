      ...
      <div className="export-shell" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="chart-report match-report">
          <header className="report-head">
            <h1>☸ Shastri — Vastu Analysis Report</h1>
          ...
          <footer className="report-foot">
            Generated by Shastri · Vastu Analysis · for learning and reflection only. <strong>This is not professional architectural or Vastu advice.</strong> Always consult qualified Vastu consultants.
          </footer>
        </div>
      </div>
    </div>
