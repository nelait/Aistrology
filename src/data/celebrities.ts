...
export const CELEBRITIES: Celebrity[] = [
  ...
  { name: "Dr. Rajkumar", region: "South India", field: "Film", year: 1929, month: 4, day: 24, hour: 12, minute: 0, timeKnown: false, zone: IN, latitude: 11.7661, longitude: 77.0057, placeLabel: "Gajanur, Erode District, Tamil Nadu, India", wiki: w("Rajkumar_(Kannada_actor)") },
